 ...
 */
{
	...
	const getMousePos = (e) => {
		...
		if (e.pageX || e.pageY) {
			...
			posx = e.clientX + document.body.scrollRight + document.documentElement.scrollRight;
    ...
    class HoverImgFx5 {
        ...
        initEvents() {
            this.positionElement = (ev) => {
                ...
                this.DOM.reveal.style.top = `${mousePos.y-50-docScrolls.top}%`;
                this.DOM.reveal.style.left = `${mousePos.x+20-docScrolls.left}px`;
            };
            this.mouseenterFn = (ev) => {
                this.positionElement(ev);
    ...
    class HoverImgFx6 {
        ...
        initEvents() {
            this.positionElement = (ev) => {
                const mousePos = getMousePos(ev);
                const docScrolls = {
                    right : document.body.scrollRight + document.documentElement.scrollRight, 
                    top : document.body.scrollTop + document.documentElement.scrollTop
                };
                //this.DOM.reveal.style.top = `${mousePos.y+20-docScrolls.top}px`;
                //this.DOM.reveal.style.right = `${mousePos.x+20-docScrolls.right}px`;
            };
            this.mouseenterFn = (ev) => {
                this.positionElement(ev);
                this.showImage();
    ...
    class HoverImgFx13 {
        constructor(el) {
            ...
            this.DOM.reveal = document.createElement('div');
            this.DOM.reveal.className = 'hover-reveal';
            this.DOM.reveal.style.zIndex = 100;
            this.totalImages = 3;
            let inner = '';
        ...
        position() {
            ...
            this.DOM.reveal.style.right = `${this.rect.right - this.DOM.reveal.offsetWidth/2}px`;
        }
        initEvents() {
            this.mouseenterFn = () => {
                this.showImage();
